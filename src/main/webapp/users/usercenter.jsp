...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var win;
		function selimage(){
			win = window.open("<%=basePath%>saveimage.jsp","","toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=yes,copyhistory=no,scrollbars=yes,width=400,height=240,top="+(screen.availHeight-240)/2+",left="+(screen.availWidth-400)/2+"");
		}
		
		function selimage1(){
			if(win!=null && $("#page1").val()!="1"){
				win.focus();
			}else{
				$("#page1").val("2");
				selimage();
				...
				<div class="box">
					<div class="box_1">
						<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
							...
							<div class="blank"></div>
							<form name="formEdit" action="index/personal.action" method="post" onsubmit="return userEdit()"  onkeydown="if(event.keyCode==13)return false;">
								<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr style="height:40px;">
										...
										<!-- ${sessionScope.users.image } images/driver.png -->
											<img border="0" id="image1" src="${sessionScope.users.image }" style="width:200px;height:200px;" onclick="selimage1();"/>
										</td>
