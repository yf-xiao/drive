		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">消费记录信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">订单号</td>
						<td align="center" bgcolor="#ebf0f7">用户</td>
						<td align="center" bgcolor="#ebf0f7">金额</td>
						<td align="center" bgcolor="#ebf0f7">方式</td>
						<td align="center" bgcolor="#ebf0f7">日期</td>
						<td align="center" bgcolor="#ebf0f7" width="10%">操作</td>
					</tr>
					<c:forEach items="${payList}" var="pay">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center"><a href="orders/getOrdersByCode.action?code=${pay.ordercode}" target="_blank">${pay.ordercode}</a></td>
							<td align="center">${pay.username}</td>
							<td align="center">${pay.money}</td>
							<td align="center">${pay.cate}</td>
							<td align="center">${pay.addtime}</td>
							<td align="center"><a
								href="pay/deletePay.action?id=${pay.payid}"
