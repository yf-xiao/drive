		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">申请提现信息列表</td>
					</tr>
					<tr align="center">
					...
					<c:forEach items="${applysList}" var="applys">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center">${applys.realname}</td>
							<td align="center">${applys.money}</td>
							<td align="center">${applys.addtime}</td>
							<td align="center">${applys.status}</td>
							<td align="center"><c:if test="${applys.status eq '未审批'}">
									<a href="applys/over.action?id=${applys.applysid}">审批</a>|
