		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">代驾接单信息列表</td>
					</tr>
					<tr align="center">
					...
					<c:forEach items="${detailsList}" var="details">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center"><a href="orders/getOrdersByCode.action?code=${details.ordercode}" target="_blank">${details.ordercode}</a></td>
							<td align="center">${details.realname}</td>
							<td align="center">${details.status}</td>
							<td align="center">${details.addtime}</td>
							<td align="center"><a
